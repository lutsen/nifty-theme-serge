Serge theme for NiftyFolder
============================

The Serge theme uses the default NiftyFolder template HTML code. To install, just replace the *theme* folder in the public folder of your NiftyFolder installation.  
